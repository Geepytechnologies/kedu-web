        ...
        <div className="flex flex-col gap-4 my-3 md:flex-row">
          ...
          >
            ...
            <p>
              ...
              tailoring nutrition plans to unique needs. We harness the power of
              technology to analyze genetic makeup, lifestyle choices, and
        ...
        <div className="flex flex-col gap-4 my-3 md:flex-row">
          ...
          >
            ...
            <p>
              ...
              leveraging technology to provide adaptive, personalized workouts.{" "}
            </p>
            <Link
              to={"/fitness"}
              className="px-3 py-2 w-[120px]  border-[#bfa85b] text-[#bfa85b] font-[500] font-[montserrat] border rounded-md"
          ...
          <motion.img
            ...
            src="/ladygym.jpg"
            className="h-[300px] md:w-[450px] object-cover rounded-md order-first md:order-last"
          />
        </div>
      </div>
    </div>
